...
export const courses: TrainingCourse[] = [
  {
    ...
    description:
      'UPchieve101 is a required training in order to be an Academic Coach. Please complete each Module before completing the quiz at the bottom.',
    quizKey: 'upchieve101',
    ...
    modules: [
      {
        ...
        materials: [
          ...
          },
          {
            ...
            isRequired: false,
            linkUrl:
              'https://join.slack.com/t/upchieveaccommunity/shared_invite/zt-ky326pfl-JCUpPDFqxeMkz1qaY9riVw'
          },
          {
