...
export const SESSION_USER_ACTIONS = <const>{
  ...
  SENT_CELEBRATION: 'SENT CELEBRATION',
}
...
export const ACCOUNT_USER_ACTIONS = <const>{
  ...
  UNSHADOW_BANNED: 'UNSHADOW_BANNED',
  ...
  PASSIVE_ON_SITE: 'PASSIVE_ON_SITE',
  INACTIVE_ON_SITE: 'INACTIVE_ON_SITE',
  LIVE_MEDIA_BANNED: 'LIVE_MEDIA_BANNED',
  UNLIVE_MEDIA_BANNED: 'UNLIVE_MEDIA_BANNED',
}
...
export const EVENTS = <const>{
  ...
  ACCOUNT_VOLUNTEER_READY: 'ACCOUNT_VOLUNTEER_READY',
  ...
  STUDENT_FALL_INCENTIVE_PROGRAM_GIFT_CARD_LIMIT_REACHED:
    'STUDENT_FALL_INCENTIVE_PROGRAM_GIFT_CARD_LIMIT_REACHED',
  SESSION_LANGUAGES_DETECTED: 'SESSION_LANGUAGES_DETECTED',
  VOLUNTEER_RECEIVED_EXCLUSIVE_REQUEST: 'VOLUNTEER_RECEIVED_EXCLUSIVE_REQUEST',
}
