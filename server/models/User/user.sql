...
/* @name getUsersWhoPassedUpc101Quiz */
SELECT DISTINCT
    uq.user_id
FROM
    users_quizzes uq
...
/* @name getUsersWithIncompleteTrainingCourse */
SELECT
    user_id
FROM
...
/* @name getUsersWithNoTrainingCourse */
...
/* @name upsertCompleteUpchieve101TrainingCourses */
