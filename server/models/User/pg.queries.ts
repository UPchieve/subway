...
export interface IUpdateUserProfileByIdParams {
  ...
  phone?: string | null | void;
  preferredLanguageCode?: string | null | void;
...
const updateUserProfileByIdIR: any = {"usedParamSet":{"deactivated":true,"phone":true,"smsConsent":true,"preferredLanguageCode":true,"userId":true},"params":[{"name":"deactivated","required":false,"transform":{"type":"scalar"},"locs":[{"a":48,"b":59}]},{"name":"phone","required":false,"transform":{"type":"scalar"},"locs":[{"a":97,"b":102}]},{"name":"smsConsent","required":false,"transform":{"type":"scalar"},"locs":[{"a":140,"b":150}]},{"name":"preferredLanguageCode","required":false,"transform":{"type":"scalar"},"locs":[{"a":206,"b":227}]},{"name":"userId","required":true,"transform":{"type":"scalar"},"locs":[{"a":270,"b":277}]}],"statement":"UPDATE\n    users\nSET\n    deactivated = COALESCE(:deactivated, deactivated),\n    phone = COALESCE(:phone, phone),\n    sms_consent = COALESCE(:smsConsent, sms_consent),\n    preferred_language_code = COALESCE(:preferredLanguageCode, preferred_language_code)\nWHERE\n    id = :userId!\nRETURNING\n    id AS ok"};
