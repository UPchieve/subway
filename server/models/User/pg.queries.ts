...
/** 'GetUsersWhoPassedUpc101Quiz' parameters type */
export type IGetUsersWhoPassedUpc101QuizParams = void;

/** 'GetUsersWhoPassedUpc101Quiz' return type */
export interface IGetUsersWhoPassedUpc101QuizResult {
  userId: string;
}

/** 'GetUsersWhoPassedUpc101Quiz' query type */
export interface IGetUsersWhoPassedUpc101QuizQuery {
  params: IGetUsersWhoPassedUpc101QuizParams;
  result: IGetUsersWhoPassedUpc101QuizResult;
}

const getUsersWhoPassedUpc101QuizIR: any = {"usedParamSet":{},"params":[],"statement":"SELECT DISTINCT\n    uq.user_id\nFROM\n    users_quizzes uq\n    JOIN quizzes q ON q.id = uq.quiz_id\nWHERE\n    q.name = 'upchieve101'\n    AND uq.passed IS TRUE\n    AND uq.created_at >= '2025-04-11 13:44:00 EST'"};
 ...
 * ```
 */
export const getUsersWhoPassedUpc101Quiz = new PreparedQuery<IGetUsersWhoPassedUpc101QuizParams,IGetUsersWhoPassedUpc101QuizResult>(getUsersWhoPassedUpc101QuizIR);


/** 'GetUsersWithIncompleteTrainingCourse' parameters type */
export interface IGetUsersWithIncompleteTrainingCourseParams {
  userIds: stringArray;
}

/** 'GetUsersWithIncompleteTrainingCourse' return type */
export interface IGetUsersWithIncompleteTrainingCourseResult {
  userId: string;
}

/** 'GetUsersWithIncompleteTrainingCourse' query type */
export interface IGetUsersWithIncompleteTrainingCourseQuery {
  params: IGetUsersWithIncompleteTrainingCourseParams;
  result: IGetUsersWithIncompleteTrainingCourseResult;
}

const getUsersWithIncompleteTrainingCourseIR: any = {"usedParamSet":{"userIds":true},"params":[{"name":"userIds","required":true,"transform":{"type":"scalar"},"locs":[{"a":84,"b":92}]}],"statement":"SELECT\n    user_id\nFROM\n    users_training_courses utc\nWHERE\n    utc.user_id = ANY (:userIds!::uuid[])\n    AND (utc.complete IS FALSE\n        OR utc.progress < 100)"};
 ...
 * ```
 */
export const getUsersWithIncompleteTrainingCourse = new PreparedQuery<IGetUsersWithIncompleteTrainingCourseParams,IGetUsersWithIncompleteTrainingCourseResult>(getUsersWithIncompleteTrainingCourseIR);


/** 'GetUsersWithNoTrainingCourse' parameters type */
export interface IGetUsersWithNoTrainingCourseParams {
  userIds: stringArray;
}

/** 'GetUsersWithNoTrainingCourse' return type */
export interface IGetUsersWithNoTrainingCourseResult {
  userId: string | null;
}

/** 'GetUsersWithNoTrainingCourse' query type */
export interface IGetUsersWithNoTrainingCourseQuery {
  params: IGetUsersWithNoTrainingCourseParams;
  result: IGetUsersWithNoTrainingCourseResult;
}

const getUsersWithNoTrainingCourseIR: any = {"usedParamSet":{"userIds":true},"params":[{"name":"userIds","required":true,"transform":{"type":"scalar"},"locs":[{"a":51,"b":59}]}],"statement":"WITH input_user_ids AS (\n    SELECT\n        unnest(:userIds!::uuid[]) AS user_id\n)\nSELECT\n    i.user_id\nFROM\n    input_user_ids i\nWHERE\n    NOT EXISTS (\n        SELECT\n            1\n        FROM\n            users_training_courses utc\n        WHERE\n            utc.user_id = i.user_id)"};

/**
 * Query generated from SQL:
 * ```
 * WITH input_user_ids AS (
 *     SELECT
 *         unnest(:userIds!::uuid[]) AS user_id
 * )
 * SELECT
 ...
 * ```
 */
export const getUsersWithNoTrainingCourse = new PreparedQuery<IGetUsersWithNoTrainingCourseParams,IGetUsersWithNoTrainingCourseResult>(getUsersWithNoTrainingCourseIR);


/** 'UpsertCompleteUpchieve101TrainingCourses' parameters type */
export interface IUpsertCompleteUpchieve101TrainingCoursesParams {
  userIds: stringArray;
}

/** 'UpsertCompleteUpchieve101TrainingCourses' return type */
export interface IUpsertCompleteUpchieve101TrainingCoursesResult {
  complete: boolean;
...
/** 'UpsertCompleteUpchieve101TrainingCourses' query type */
export interface IUpsertCompleteUpchieve101TrainingCoursesQuery {
  params: IUpsertCompleteUpchieve101TrainingCoursesParams;
  result: IUpsertCompleteUpchieve101TrainingCoursesResult;
}

const upsertCompleteUpchieve101TrainingCoursesIR: any = {"usedParamSet":{"userIds":true},"params":[{"name":"userIds","required":true,"transform":{"type":"scalar"},"locs":[{"a":371,"b":379}]}],"statement":"INSERT INTO users_training_courses (user_id, training_course_id, complete, progress, completed_materials, created_at, updated_at)\nSELECT\n    user_id,\n    1 AS training_course_id,\n    TRUE AS complete,\n    100 AS progress,\n    ARRAY['7b6a76', 'jsn832', 'ps87f9', 'jgu55k', 'fj8tzq'] AS completed_materials,\n    NOW() AS created_at,\n    NOW() AS updated_at\nFROM\n    unnest(:userIds!::uuid[]) AS user_id\nON CONFLICT (user_id,\n    training_course_id)\n    DO UPDATE SET\n        complete = TRUE,\n        progress = 100,\n        completed_materials = ARRAY['7b6a76', 'jsn832', 'ps87f9', 'jgu55k', 'fj8tzq'],\n        updated_at = NOW()\n    RETURNING\n        *"};

/**
 * Query generated from SQL:
 * ```
 * INSERT INTO users_training_courses (user_id, training_course_id, complete, progress, completed_materials, created_at, updated_at)
 * SELECT
 *     user_id,
 *     1 AS training_course_id,
 *     TRUE AS complete,
 ...
 * ```
 */
export const upsertCompleteUpchieve101TrainingCourses = new PreparedQuery<IUpsertCompleteUpchieve101TrainingCoursesParams,IUpsertCompleteUpchieve101TrainingCoursesResult>(upsertCompleteUpchieve101TrainingCoursesIR);
