...
test('Start date and end date are the same day', () => {
...
test('Start Date: first of leap year - End Date: first of next year', () => {
...
test('Start Date: first of year - End Date: first of next year', () => {
...
test('February day of week frequency should have one extra day on leap year', () => {
...
test('February day of week frequency should all be 4', () => {
...
test('String dates to fn should return correct output', () => {
