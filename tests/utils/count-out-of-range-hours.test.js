...
test('User has no hours out of range selected', () => {
...
test('All hours out of range are selected - (Daylight Saving)', () => {
  // EST Time Zone for dates
...
test('Some hours out of range are selected - (Daylight Saving)', () => {
  // EST Time Zone for dates
