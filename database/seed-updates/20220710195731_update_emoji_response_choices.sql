-- migrate:up
INSERT INTO
  upchieve.survey_response_choices (score, choice_text, display_image, created_at, updated_at)
SELECT
  3,
  'Neutral',
...
WHERE  
  (upchieve.surveys.name = 'STEM Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to learn this topic?' AND rc.choice_text = 'Neutral' AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'Humanities Essays Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to learn this topic?' AND rc.choice_text = 'Neutral' AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'Reading Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to learn this topic?' AND rc.choice_text = 'Neutral'  AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'SAT Prep Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to learn this topic?' AND rc.choice_text = 'Neutral'  AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'College Planning Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to get accepted to college?' AND rc.choice_text = 'Neutral' AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'College Essays Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to get accepted to college?' AND rc.choice_text = 'Neutral' AND sub.text::int = 30) OR
  (upchieve.surveys.name = 'College Applications Pre-Session Survey' AND sq.question_text = 'How do you feel about your ability to get accepted to college?' AND rc.choice_text = 'Neutral' AND sub.text::int = 30);
