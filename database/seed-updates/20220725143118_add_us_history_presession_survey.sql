...
VALUES (0, 'Other', NOW(), NOW()),
       (1, 'Not at all', NOW(), NOW());
...
WHERE (SELECT id = ANY (ids) FROM other_ids);
...
DELETE FROM upchieve.survey_response_choices
WHERE (SELECT id = ANY (ids) FROM not_at_all_ids);
...
WHERE
  ...
  (upchieve.surveys.name = 'U.S. History Pre-Session Survey' AND sq.question_text = 'Overall, how do you feel about %s?' AND rc.choice_text = 'Confident' AND sub.text::int = 50) OR

  -- migrate over old questions to new 'Other' and 'Not at all' response choices
  (upchieve.surveys.name = 'STEM Pre-Session Survey' AND sq.question_text = 'What is your primary goal for today''s session?' AND rc.choice_text = 'Other' AND sub.text::int = 70) OR
  ...
  (upchieve.surveys.name = 'STEM Pre-Session Survey' AND sq.question_text = 'How well do you understand the topic you want to talk about today?' AND rc.choice_text = 'Not at all' AND sub.text::int = 10) OR
  (upchieve.surveys.name = 'Humanities Essays Pre-Session Survey' AND sq.question_text = 'How well do you understand the topic you want to talk about today?' AND rc.choice_text = 'Not at all' AND sub.text::int = 10) OR
  (upchieve.surveys.name = 'Reading Pre-Session Survey' AND sq.question_text = 'How well do you understand the topic you want to talk about today?' AND rc.choice_text = 'Not at all' AND sub.text::int = 10) OR
  (upchieve.surveys.name = 'SAT Prep Pre-Session Survey' AND sq.question_text = 'How well do you understand the topic you want to talk about today?' AND rc.choice_text = 'Not at all' AND sub.text::int = 10) OR
  ...
  (upchieve.surveys.name = 'College Counseling Volunteer Post-Session Survey' AND sq.question_text = '%s''s goal for this session was to %s. Were you able to help them achieve their goal?' AND rc.choice_text = 'Not at all' AND sub.text::int = 10);
