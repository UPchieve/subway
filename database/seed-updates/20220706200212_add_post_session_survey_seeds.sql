...
VALUES (1, 'Not at all', NOW(), NOW()),
       ...
       (0, 'Rude coach', NOW(), NOW()),
       (0, 'Coach didn''t know topic', NOW(), NOW()),
...
WHERE
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'prealgebra' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'algebraOne' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'algebraTwo' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'geometry' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'trigonometry' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'precalculus' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'calculusAB' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'calculusBC' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'statistics' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'biology' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'chemistry' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'physicsOne' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'physicsTwo' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'environmentalScience' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'integratedMathOne' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'integratedMathTwo' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'integratedMathThree' AND upchieve.survey_types.name = 'postsession') OR
  (upchieve.surveys.name = 'Student Post-Session Survey' AND upchieve.subjects.name = 'integratedMathFour' AND upchieve.survey_types.name = 'postsession') OR
