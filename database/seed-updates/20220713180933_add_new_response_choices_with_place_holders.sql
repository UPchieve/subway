...
WHERE
  (
    upchieve.surveys.name = 'College Planning Pre-Session Survey'
...
DELETE FROM
  upchieve.surveys_context using upchieve.surveys
WHERE
  upchieve.surveys_context.survey_id = upchieve.surveys.id
