...
export async function quizSubcategories(quizIds: NameToId) {
  const quizSubs = [
    ...
    {
      name: 'nonnvarying_sentence_length',
      quizId: quizIds['humanitiesEssays'] as number,
    },
    {
      name: 'wordiness',
    ...
    { name: 'inference',
      quizId: quizIds['satReading'] as number },
    { name: 'integumentary',
      quizId: quizIds['anatomy'] as number },
    { name: 'little_detail',
      quizId: quizIds['satReading'] as number },
    { name: 'lymphatic',
      quizId: quizIds['anatomy'] as number },
...
{ name: 'graphing trig functions', quizId: quizIds['trigonometry'] as number },
{ name: 'inverse trig functions', quizId: quizIds['trigonometry'] as number },
{ name: 'trigonometric identities', quizId: quizIds['trigonometry'] as number },
{ name: 'complex numbers', quizId: quizIds['precalculus'] as number },
{ name: 'conic sections', quizId: quizIds['precalculus'] as number },
{ name: 'graphing exponential functions', quizId: quizIds['precalculus'] as number },
{ name: 'graphing polynomials', quizId: quizIds['precalculus'] as number },
{ name: 'graphing rational functions', quizId: quizIds['precalculus'] as number },
...
{ name: 'exponential logarithmic equations', quizId: quizIds['precalculus'] as number },
{ name: 'other equations', quizId: quizIds['precalculus'] as number },
{ name: 'quadratic and absolute', quizId: quizIds['precalculus'] as number },
{ name: 'solving quadratic equations', quizId: quizIds['precalculus'] as number },
{ name: 'transformations functions', quizId: quizIds['precalculus'] as number },
{ name: 'vectors', quizId: quizIds['precalculus'] as number },
{ name: 'trig functions', quizId: quizIds['trigonometry'] as number },
{ name: 'random variables and distributions', quizId: quizIds['statistics'] as number },
